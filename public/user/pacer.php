...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST') {
    ...
    try {
        ...
        $errors[] = $e instanceof InvalidArgumentException ? $e->getMessage() : 'Não foi possível salvar a estratégia.';
    }
}
        ...
        <section class="pacer-editor">
            <form method="post" data-pacer-form>
                ...
                <div class="pacer-fields">
                    ...
                    <label><span>Tempo-alvo</span><input type="text" name="target_time" inputmode="numeric" required value="<?php echo $editing ? stridebr_e(stridebr_pacer_web_time($editing['target_time_s'])) : '52:00'; ?>" placeholder="52:00"></label>
                ...
                <div class="pacer-generation-fields" data-generated-options>
