...
<section class="insight-section"><header><div><h2>Resumo</h2></div></header><table class="compare-table"><tbody><tr><td>Esforço percebido</td><td><?php echo $a['esforco'] !== null ? (int)$a['esforco'].'/10' : '—'; ?></td><td><?php echo $b['esforco'] !== null ? (int)$b['esforco'].'/10' : '—'; ?></td></tr><?php foreach ($comparison['metricas'] as $metric): if (preg_match('/eleva|desn[ií]vel|relevo|altitude|ganho/i', (string) ($metric['rotulo'] ?? ''))) continue; ?><tr><td><?php echo stridebr_e((string) $metric['rotulo']); ?></td><td><?php echo stridebr_e((string) $metric['a']); ?></td><td><?php echo stridebr_e((string) $metric['b']); ?></td></tr><?php endforeach; ?><tr><td>Equipamento</td><td><?php echo stridebr_e(implode(', ', array_column($a['equipamentos'] ?? [], 'nome')) ?: '—'); ?></td><td><?php echo stridebr_e(implode(', ', array_column($b['equipamentos'] ?? [], 'nome')) ?: '—'); ?></td></tr></tbody></table></section>
