                    ...
                    <div class="settings-sports-catalog" data-settings-sports-catalog>
                        ...
                        <?php foreach ($settingsSportGroups as $group): ?>
                            <section class="settings-sport-family-panel" data-settings-sport-family-panel="<?php echo stridebr_e((string) $group['key']); ?>" hidden>
                                <div class="settings-sport-family-head"><button type="button" data-settings-sport-family-back><?php echo stridebr_e(stridebr_t('settings.back_categories')); ?></button><div><strong><?php echo stridebr_e((string) $group['label']); ?></strong><small><?php echo stridebr_e((string) $group['description']); ?></small></div></div>
