...
$allowedTrainingExperience = ['', 'comecando', 'retornando', 'pratico', 'regular'];
        ...
        <div class="page-shell settings-shell">
            ...
            <form method="POST" enctype="multipart/form-data" class="content-card settings-form settings-view-<?php echo stridebr_e($settingsView); ?>">
                ...
                <section class="settings-section" id="preferencias-treino" data-settings-area="settings">
                    ...
                    <div class="settings-grid">
                        <label><?php echo stridebr_e(stridebr_t('settings.experience')); ?><select name="training_experience"><option value=""<?php echo $trainingExperienceSettings === '' ? ' selected' : ''; ?>><?php echo stridebr_e(stridebr_t('settings.prefer_not')); ?></option><option value="comecando"<?php echo $trainingExperienceSettings === 'comecando' ? ' selected' : ''; ?>><?php echo stridebr_e(stridebr_t('settings.beginner')); ?></option><option value="retornando"<?php echo $trainingExperienceSettings === 'retornando' ? ' selected' : ''; ?>><?php echo stridebr_e(stridebr_t('settings.returning')); ?></option><option value="pratico"<?php echo $trainingExperienceSettings === 'pratico' ? ' selected' : ''; ?>><?php echo stridebr_e(stridebr_t('settings.active')); ?></option><option value="regular"<?php echo $trainingExperienceSettings === 'regular' ? ' selected' : ''; ?>><?php echo stridebr_e(stridebr_t('settings.regular')); ?></option></select></label>
