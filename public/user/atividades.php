    ...
    <main class="main-content activities-page" data-activities-page data-csrf-token="<?php echo stridebr_e(stridebr_csrf_token()); ?>">
        ...
        <header class="activities-toolbar">
            ...
            <div class="activities-toolbar-actions">
                ...
                <a href="/user/importar-exportar.php#importar" class="activity-toolbar-link activity-toolbar-essential" data-activity-tool="exchange"><?php echo stridebr_e(stridebr_t('activity.import_activity')); ?></a>
        ...
        <div class="activity-detail-drawer" data-activity-detail-drawer hidden>
            <section class="activity-detail-panel" role="region" aria-labelledby="activity-detail-title" data-activity-detail-panel>
                ...
                <button type="button" class="activity-detail-close" data-close-activity-detail aria-label="<?php echo stridebr_e(stridebr_t('common.close')); ?>">×</button>
                <header>
                    ...
                    <div class="activity-detail-header-actions"><div class="activity-detail-full-actions" data-detail-full-actions hidden><button type="button" class="activity-secondary-button" data-share-activity><?php echo stridebr_e(stridebr_t('activity.detail_share')); ?></button><template data-detail-open-full-template><button type="button" class="activity-primary-action" data-open-full-activity-details data-detail-open-full><?php echo stridebr_e(stridebr_t('activity.detail.expand')); ?></button></template><a class="activity-primary-action" data-detail-edit href="/user/editatividade.php" hidden><?php echo stridebr_e(stridebr_t('activity.detail_edit')); ?></a><details class="activity-v3-actions-menu activity-detail-header-menu" data-detail-actions-menu><summary class="activity-secondary-button" aria-label="<?php echo stridebr_e(stridebr_t('common.more_options')); ?>">…</summary><div role="menu"><details class="activity-detail-export-submenu" data-detail-export><summary role="menuitem"><?php echo stridebr_e(stridebr_t('activity.export')); ?></summary><div><a role="menuitem" data-detail-export-json>JSON</a><a role="menuitem" data-detail-export-tcx>TCX</a><a role="menuitem" data-detail-export-gpx hidden>GPX</a></div></details><a role="menuitem" data-detail-compare data-activity-tool="compare" href="/user/comparar-atividades.php"><?php echo stridebr_e(stridebr_t('activity.compare')); ?></a><a role="menuitem" data-detail-repeat href="/user/atividades.php"><?php echo stridebr_e(stridebr_t('activity.repeat')); ?></a><button type="button" role="menuitem" class="activity-detail-stats-toggle" data-detail-stats aria-pressed="false"></button><button type="button" role="menuitem" class="is-danger" data-detail-delete><?php echo stridebr_e(stridebr_t('common.delete')); ?></button></div></details></div></div>
                </header>
