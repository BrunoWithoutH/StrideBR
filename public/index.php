    ...
    <main class="main-content">
        <div class="landing-shell">
            ...
            <section class="landing-hero">
                <div class="landing-copy"><span class="landing-eyebrow">Treinos e atividades</span><h1><span class="landing-brand-name">StrideBR</span> <span>Planeje. Treine.<br> Registre sua evolução.</span></h1><p>StrideBR é uma plataforma esportiva brasileira, livre e open source, para planejar treinos, registrar atividades físicas e acompanhar evolução.</p><div class="landing-actions"><a class="landing-primary" href="/signup.php">Criar conta</a><a class="landing-secondary" href="/login.php">Já tenho uma conta</a></div></div>
