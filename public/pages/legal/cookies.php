...
<h2>Publicidade</h2><p>O StrideBR possui infraestrutura opcional de publicidade, desligada por padrão. Antes de qualquer ativação real, o serviço precisa estar configurado com domínio aprovado, política de consentimento/CMP aplicável e os controles exigidos pelo fornecedor no momento da publicação.</p><p>Dados esportivos ou recebidos de conexões externas não são enviados pelo StrideBR como parâmetros de segmentação publicitária. Páginas operacionais e sensíveis continuam fora da arquitetura de anúncios.</p>
