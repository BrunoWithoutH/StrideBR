...
try {
    ...
    $data = activityStreamLaps($pdo, $idUsuario, $id);
    ...
    if (!$e instanceof InvalidArgumentException) error_log('StrideBR activity laps web API: ' . $e->getMessage());
    echo json_encode(['ok' => false, 'error' => $e instanceof InvalidArgumentException ? $e->getMessage() : 'Não foi possível carregar as voltas.'], JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
}
