...
$headerIcon = static function (string $name): string {
    $paths = match ($name) {
        ...
        'equipment' => '<path d="M6 9v6M3 10v4M18 9v6M21 10v4M6 12h12"></path>',
...
<header class="site-header">
    <div class="header-inner">
        ...
        <nav class="main-nav" data-nav-menu aria-label="<?php echo stridebr_e(stridebr_t('nav.open_navigation')); ?>">
            ...
            <details data-header-menu="hover-toggle" class="nav-menu-group<?php echo $headerActive(['/user/cronogramatreinos.php', '/user/agenda-mensal.php', '/user/biblioteca.php', '/user/treinador.php', '/user/exercicioscronograma.php', '/user/exerciciostreinomodelo.php']); ?>">
            ...
            <a class="<?php echo trim($headerActive(['/user/atividades.php', '/user/editatividade.php', '/user/gravar-atividade.php'])); ?>" href="/user/atividades.php"><?php echo stridebr_e(stridebr_t('nav.activities')); ?></a>
            ...
            <details data-header-menu="hover-toggle" class="nav-menu-group<?php echo $headerActive(['/user/pacer.php','/user/rotas.php','/user/zonas.php','/user/ferramentastreino.php']); ?>"><summary><?php echo stridebr_e(stridebr_t('nav.tools')); ?> <svg viewBox="0 0 16 16" aria-hidden="true"><path d="m4.5 6 3.5 3.5L11.5 6"></path></svg></summary><div class="nav-dropdown"><a href="/user/pacer.php"><strong><?php echo stridebr_e(stridebr_t('tools.pacer')); ?></strong><span><?php echo stridebr_e(stridebr_t('tools.pacer_help')); ?></span></a><a href="/user/rotas.php"><strong><?php echo stridebr_e(stridebr_t('tools.routes')); ?></strong><span><?php echo stridebr_e(stridebr_t('tools.routes_help')); ?></span></a><a href="/user/zonas.php"><strong><?php echo stridebr_e(stridebr_t('tools.zones')); ?></strong><span><?php echo stridebr_e(stridebr_t('tools.zones_help')); ?></span></a><a href="/user/ferramentastreino.php"><strong><?php echo stridebr_e(stridebr_t('tools.quick_title')); ?></strong><span><?php echo stridebr_e(stridebr_t('tools.quick_help')); ?></span></a></div></details>
                        ...
                        <div class="header-notification-list">
                            ...
                            <?php else: ?>
                                <?php foreach ($headerNotifications as $notification): ?>
                                    <?php $notificationDestination = function_exists('notificacaoDestinoSeguro') ? notificacaoDestinoSeguro((string) ($notification['url'] ?? '')) : trim((string) ($notification['url'] ?? '')); $notificationUrl = $notificationDestination !== '' && function_exists('notificacaoUrlAbertura') ? notificacaoUrlAbertura($notification) : '/user/notificacoes.php'; $notificationCopy = function_exists('notificacaoApresentar') ? notificacaoApresentar($notification) : ['titulo' => (string) ($notification['titulo'] ?? ''), 'mensagem' => (string) ($notification['mensagem'] ?? '')]; ?>
