...
$assert(str_contains($detailJs, 'data-activity-v3-map') && str_contains($detailJs, 'StrideBRWebMap?.mount?.'), 'Activity com rota precisa montar o componente de mapa real.');
$assert(str_contains($mapJs, 'StrideBRBasemaps?.attach') && str_contains($mapJs, 'L.polyline') && str_contains($mapJs, 'fitBounds'), 'componente compartilhado precisa usar basemap real, polyline e fit bounds.');
...
$assert(str_contains($detailJs, 'data-chart-metric') && str_contains($detailJs, 'data-chart-cursor') && str_contains($detailJs, 'activity-v3-chart-tooltip'), 'gráficos precisam permitir seleção de métricas e cursor/tooltip sincronizado.');
...
$assert(str_contains($detailCss, '.activity-v3-chart') && str_contains($detailCss, '.activity-v3-map'), 'mapa e gráficos precisam possuir containers dedicados e dimensionados.');
...
$assert(str_contains($presenter, "'metrica_derivada'") && str_contains($detailJs, 'metrica_derivada'), 'comportamento pace/speed precisa usar metadata canônica da modalidade.');
