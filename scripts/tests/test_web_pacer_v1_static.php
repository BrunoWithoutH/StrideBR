...
$assert(str_contains($header, '/user/pacer.php') && str_contains($header, "'/user/pacer.php','/user/rotas.php','/user/zonas.php','/user/ferramentastreino.php'"), 'Pacer deve estar acessível pela navegação de Ferramentas.');
...
$assert(str_contains($page, 'field-with-unit') && str_contains($css, '.pacer-page .pacer-editor .pacer-input-unit.field-with-unit input[type="number"]{') && !str_contains($page, '<b>km</b>'), 'Campos com unidade precisam usar um único contorno visual.');
