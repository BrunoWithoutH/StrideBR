...
$assert(count($current) === 9, 'deploy atual deve possuir nove migrations: consolidação e aditivas de precisão, integrações, Marketing e webhooks Strava.');
$assert(count($appliedSimulation) === 45, 'histórico após as migrations aditivas deve totalizar 45 registros.');
