...
$checks = [
    ...
    'internet offline não destrói gravação e impede envio inseguro' => str_contains($js, "t('gps.offline_saved')") && str_contains($js, 'if (!navigator.onLine)') && str_contains($page, "stridebr_t('gps.offline_help')"),
