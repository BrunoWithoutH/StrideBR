...
$checks = [
    ...
    'progresso fase A prioriza resumo destaques esportes metas consistência e distribuição' => str_contains($progress, 'progress-summary-title') && str_contains($progress, 'progress-highlights-title') && str_contains($progress, 'progress-sports-title') && str_contains($progress, 'progress-goals-title') && str_contains($progress, 'progress-consistency-title') && str_contains($progress, 'progress-distribution-title') && !str_contains($progress, "progress.question_consistency"),
