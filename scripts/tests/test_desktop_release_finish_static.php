...
$checks = [
    ...
    'progresso mostra consistência volume tendência e comparação' => str_contains($progress, "stridebr_t('progress.question_consistency')") && str_contains($progress, 'progress-volume-title') && str_contains($progress, 'progress-trend-title') && str_contains($progress, 'progress-comparison-list'),
    ...
    'legais atualizadas para a RC' => str_contains($terms, '30 de agosto de 2026') && str_contains($privacy, '1º de setembro de 2026') && str_contains($privacy, 'Analytics de produto') && str_contains($privacy, 'trechos privados') && str_contains($cookies, 'CMP') && str_contains($cookies, 'desligada por padrão'),
