...
$checks = [
    ...
    'progresso mostra consistência e tendências' => str_contains($progress, "stridebr_t('progress.last_8_weeks')") && (str_contains($progress, "stridebr_t('progress.compare_previous')") || str_contains($progress, "progress.weeks_comparison_help")) && str_contains($progress, "stridebr_t('progress.personal_bests')"),
    ...
    'empty states úteis existem nas áreas novas' => str_contains($progress, "stridebr_t('progress.first_record')") && str_contains($activitiesPage, "stridebr_t('activity.log')") && str_contains($exchangePage, "stridebr_t('progress.log_activity')") && str_contains($trainer, "stridebr_t('trainer.no_active_schedules')"),
];
