...
$assert(str_contains($progress, 'progress-period-presets') && str_contains($progress, 'name="period"') && str_contains($progress, '$buildUrl([') && str_contains($progress, "'period' => \$key"), 'Progresso precisa oferecer poucos presets úteis e preservar a janela selecionada.');
...
$assert(str_contains($hubCss, '.progress-filterbar') && str_contains($hubCss, '.progress-period-presets') && str_contains($hubCss, '@media(max-width:820px)'), 'filtros de Progresso precisam ser compactos e responsivos.');
