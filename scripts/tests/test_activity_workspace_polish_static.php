...
$assert(!str_contains($page, 'class="activity-toolbar-tools"') && str_contains($page, '/user/importar-exportar.php') && str_contains($page, 'data-detail-compare'), 'Atividades deve manter importação direta e Comparar contextual sem menu de um item.');
