...
$checks = [
    ...
    'service worker pré-cacheia apenas shell estático seguro' => str_contains($sw, "const STATIC_CACHE = 'stridebr-static-v3-'") && str_contains($sw, "'/assets/css/style.css'") && str_contains($sw, "'/assets/js/pwa.js'") && str_contains($sw, "'/offline.html'") && !str_contains($sw, "'/api/") && !str_contains($sw, "'/user/atividades.php'"),
