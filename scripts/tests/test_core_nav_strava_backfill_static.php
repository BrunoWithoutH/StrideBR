...
$assert(str_contains($integrations, "'detail_budget'") && str_contains($integrations, "'deadline'") && str_contains($integrations, "'backfill_deferred_reason' => \$deferReason"), 'Backfill parcial precisa distinguir teto de detalhes de deadline sem avançar cursor.');
