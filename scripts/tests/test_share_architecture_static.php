...
$tests=[
 ...
 ['share background colors include deep dark black white', substr_count($view,'data-share-background-color')===4 && str_contains($view,'value="deep" data-share-background-color') && str_contains($view,'value="dark" data-share-background-color') && str_contains($view,'value="black" data-share-background-color') && str_contains($view,'value="white" data-share-background-color') && !str_contains($view,'value="light" data-share-background-color')],
