...
$assertions = [
    ...
    'skeleton inicial não bloqueia o conteúdo' => str_contains($page, 'data-history-skeleton aria-label="<?php echo stridebr_e(stridebr_t(\'activity.loading_history_aria\')); ?>" hidden'),
    ...
    'detalhes não fazem prefetch por hover' => !str_contains($js, "historyList?.addEventListener('pointerover'") && !str_contains($js, "historyList?.addEventListener('focusin'"),
